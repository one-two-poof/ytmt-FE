...
- Name: components.test.ts >> Button >> primary — hover 상태
- Location: tests/visual/components.test.ts:32:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/button-primary-hover-desktop-darwin.png, writing actual.
```
