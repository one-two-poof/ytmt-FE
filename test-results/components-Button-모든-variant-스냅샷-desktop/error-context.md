...
- Name: components.test.ts >> Button >> 모든 variant 스냅샷
- Location: tests/visual/components.test.ts:25:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/button-variants-desktop-darwin.png, writing actual.
```
