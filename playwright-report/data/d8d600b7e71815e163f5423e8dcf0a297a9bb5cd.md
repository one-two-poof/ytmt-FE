...
- Name: components.test.ts >> Input >> textarea 포커스 상태
- Location: tests/visual/components.test.ts:96:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/textarea-focused-desktop-darwin.png, writing actual.
```
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e55]:
      ...
      - generic [ref=e69]:
        ...
        - textbox "오늘 어떤 생각을 하셨나요? 솔직하게 적어보세요." [active] [ref=e71]
      - generic [ref=e73]:
