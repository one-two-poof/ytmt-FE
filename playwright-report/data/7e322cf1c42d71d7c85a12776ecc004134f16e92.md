...
- Name: components.test.ts >> 전체 컴포넌트 페이지 스냅샷
- Location: tests/visual/components.test.ts:13:5

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/full-page-desktop-darwin.png, writing actual.
```
