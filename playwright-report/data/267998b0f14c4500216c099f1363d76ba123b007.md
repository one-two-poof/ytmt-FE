...
- Name: components.test.ts >> Badge >> 모든 variant 스냅샷
- Location: tests/visual/components.test.ts:123:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/badge-variants-desktop-darwin.png, writing actual.
```
