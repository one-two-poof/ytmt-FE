...
- Name: components.test.ts >> Card >> interactive — hover 상태
- Location: tests/visual/components.test.ts:68:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/card-interactive-hover-desktop-darwin.png, writing actual.
```
