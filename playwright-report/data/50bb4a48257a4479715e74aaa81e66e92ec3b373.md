...
- Name: components.test.ts >> Card >> 모든 variant 스냅샷
- Location: tests/visual/components.test.ts:61:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/card-variants-desktop-darwin.png, writing actual.
```
