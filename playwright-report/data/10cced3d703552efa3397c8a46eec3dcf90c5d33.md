...
- Name: components.test.ts >> Button >> disabled 상태
- Location: tests/visual/components.test.ts:49:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/button-disabled-desktop-darwin.png, writing actual.
```
