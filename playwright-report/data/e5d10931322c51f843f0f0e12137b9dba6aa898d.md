...
- Name: components.test.ts >> Spinner >> 모든 size 스냅샷
- Location: tests/visual/components.test.ts:136:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/spinner-sizes-desktop-darwin.png, writing actual.
```
