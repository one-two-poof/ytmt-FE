...
- Name: components.test.ts >> Input >> 기본 · 에러 · 비활성화 스냅샷
- Location: tests/visual/components.test.ts:81:7

# Error details

```
Error: A snapshot doesn't exist at /Users/sanginjeong/Desktop/side-project/ytmt/tests/visual/__snapshots__/components.test.ts-snapshots/input-states-desktop-darwin.png, writing actual.
```
